...
void setupServiceLocator() {
  ...
  di.registerFactory<ProfileBloc>(
    () => ProfileBloc(
      getUserProfile: di.get<GetUserProfileUseCase>(),
      updateProfile: di.get<UpdateProfileUseCase>(),
      uploadProfilePhoto: di.get<UploadProfilePhotoUseCase>(),
      changePassword: di.get<ChangePasswordUseCase>(),
      getUserOrders: di.get<GetUserOrdersUseCase>(),
      signOut: di.get<SignOutUseCase>(),
    ),
  );
}
